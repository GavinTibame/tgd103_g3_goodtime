...
insert  into `PRODUCT`(`ID`,`PRODUCT_NAME`,`STATUS`,`HIDE`,`PRICE`,`DESC`,`MAIN_PHOTO`,`STOCK_QTY`,`MAX_QTY`,`CREATE_DATE`,`EDIT_DATE`,`FK_PRODUCT_PAGE_ID`,`FK_SUPPLIER_ID`,`FK_PRODUCT_TYPE_ID`,`SPEC`,`NOTE`,`FEATURED`,`START`,`END`) values 
